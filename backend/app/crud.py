...
from backend.app.models import Vacancy, VacancyCertifications, VacancyOptionalSkills, VacancyRequiredSkills, VacancyResponsibilities
from backend.app.schemas import VacancyCreate
